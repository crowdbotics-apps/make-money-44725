"""
Django settings for make_money_44725 project.
...
ROOT_URLCONF = 'make_money_44725.urls'
...
WSGI_APPLICATION = 'make_money_44725.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "make_money_44725 API",
    "DESCRIPTION": "API documentation for make_money_44725 App",
    "VERSION": "v1",
}
